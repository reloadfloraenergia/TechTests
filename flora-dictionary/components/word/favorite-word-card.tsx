...
type FavoriteWordCardProps = {
  favorite: FavoriteWord;
  onRemove: (word: string) => void;
};

export function FavoriteWordCard({ favorite, onRemove }: FavoriteWordCardProps) {
  return (
    <article className="rounded-[2rem] border border-[#6A00F4]/10 bg-white p-6 shadow-lg transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-[#1F0A3D]">
